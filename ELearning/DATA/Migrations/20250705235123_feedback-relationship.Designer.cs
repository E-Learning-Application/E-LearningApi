...
namespace DATA.Migrations
{
    ...
    [Migration("20250705235123_feedback-relationship")]
    partial class feedbackrelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DATA.Models.Feedback", b =>
                {
                    ...
                    b.HasIndex("FeedbackedId");

                    b.HasIndex("FeedbackerId");

                    b.ToTable("Feedbacks", t =>
                        {
                            t.HasCheckConstraint("CK_Feedback_NoSelfFeedback", "FeedbackerId != FeedbackedId");
                        });
                });
            ...
            modelBuilder.Entity("DATA.Models.Feedback", b =>
                {
                    b.HasOne("DATA.Models.AppUser", "Feedbacked")
                        .WithMany("ReceivedFeedbacks")
                        .HasForeignKey("FeedbackedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DATA.Models.AppUser", "Feedbacker")
                        .WithMany("GivenFeedbacks")
                        .HasForeignKey("FeedbackerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Feedbacked");
